            ...
            if(choice.equals("1")){
                ...
                if(s.Uctrl.signIn(email, password)) {
                    ...
                    while (true) {
                        ...
                        if(tmpUser.equals("1")){
                            String serviceName;
                            System.out.println("Spaces not allowed, enter someTHing like internetPaymentServices");
                            System.out.println("Enter service name");
                            serviceName = scan.next();
                            System.out.println("Enter Payment method, like wallet ..... credit");
                            String method;
                            method = scan.next();
                            Payment p;
                    ...
                    while (true){
                        ...
                        if(tmpAdmin.equals("1")){
                            System.out.println("Spaces not allowed");
                            System.out.println("Enter the type of your discount, aka specific/overall");
